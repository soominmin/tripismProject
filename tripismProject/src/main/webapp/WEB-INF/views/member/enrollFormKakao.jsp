...
<body id="body" class="up-scroll">
	<section class="py-9">
		...
		<form action="insert.do" method="post" id="enrollForm" enctype="multipart/form-data" >

		<div class="mb-3"  style="width: 400px; margin: auto;">
			아이디⭐ <br>
			<input type="text" name="memId" id="memId" class="form-control bg-smoke" required value="${insertMember.memId }">
		...
		<div class="mb-3" style="width: 400px; margin: auto;">
			이메일⭐<br>
			<input type="email" name="email"class="form-control bg-smoke" required placeholder="이메일을 입력해주세요." value="${insertMember.email }">
		...
		<div class="mb-3" style="width: 400px; margin: auto;">
			닉네임⭐ <br>
			<input type="text" name="memNickname" class="form-control bg-smoke" required placeholder="닉네임을 입력해주세요." value="${insertMember.memNickname }">
