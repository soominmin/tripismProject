        ...
        <div class="col-12">
          <div class="row">
            <div class="col-lg-6" style="margin: auto;" align="center">
              ...
              <form action="pwdResult.do">
	              <div class="modal-body" style="padding-top:0;">
	              
	                  <div class="mb-3" style="width: 500px;">
	                    <input type="text" class="form-control bg-smoke" name="memId" placeholder="아이디" style="width:300px" required>
	                  </div>
	                  ...
	                  <div class="row" style="text-align: center;">
	                    <div class="pt-3">
	                      <button type="submit" class="btn btn-primary text-uppercase font-size-15 px-3 px-md-6" id="infoUpdate" style="width:100px;">확인</button>
	                    </div>
	                </div>
	            </div>
            </form>
