						...
						<div class="filter__WebItemWrapper-sc-1055oli-2 gZYroh">
							...
							<div class="filter__WebContinentFilter-sc-1055oli-3 cksfQf">
								<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
									<button width="auto" font-size="15px" font-weight="500" class="ButtonWithToggle__ButtonWrapper-sc-b2wh5i-2 jWOSQK" style="width: 220px; justify-content: flex-start;">
										어디로 떠나실 건가요?</button>
								</div>
							</div>
							...
							<div class="filter__WebCountryFilter-sc-1055oli-4 gZpguq">
								...
								<div class="filter__WebCountryItemWrapper-sc-1055oli-5 fTvelu">
									<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
										<button width="auto" font-size="15px" font-weight="500" type="button"
											class="ButtonWithToggle__ButtonWrapper-sc-b2wh5i-2 bKQVyS"
											style="width: 144px; justify-content: flex-start;">전라도</button>
									</div>
									<div>
										<div>
											<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
								...
								<div class="filter__WebCountryItemWrapper-sc-1055oli-5 fTvelu">
									<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
										<button width="auto" font-size="15px" font-weight="500" type="button"
											class="ButtonWithToggle__ButtonWrapper-sc-b2wh5i-2 bKQVyS"
											style="width: 144px; justify-content: flex-start;">충청도</button>
									</div>
									<div>
										<div>
											<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
								...
								<div class="filter__WebCountryItemWrapper-sc-1055oli-5 fTvelu">
									<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
										<button width="auto" font-size="15px" font-weight="500" type="button"
											class="ButtonWithToggle__ButtonWrapper-sc-b2wh5i-2 bKQVyS"
											style="width: 144px; justify-content: flex-start;">강원도</button>
									</div>
									<div>
										<div>
											<div class="ButtonWithToggle__RelativeBox-sc-b2wh5i-0 StvrC">
	...
	<div class="WriteSelectionModal__StyledContentBox-sc-1cknulk-6 dBcUhY">
		...
		<script>
			$j(document).ready(function () {
				...
				var selectedBtns = [];
				// 버튼 클릭 이벤트 핸들러 등록
				$j(document).on("click",".WriteSelectionModal__StyledAnswer-sc-1cknulk-7.ckUMfu",function () {
					// 클릭된 버튼의 클래스 변경
					$j(this).removeClass("ckUMfu").addClass("eWrVZP");
					// 선택된 버튼이 3개 이상일 경우 가장 오래된 버튼을 배열에서 제거하고 해당 버튼의 클래스를 초기화
					if (selectedBtns.length >= 3) {
						var oldestBtn = selectedBtns.shift();
						oldestBtn.removeClass("eWrVZP bnbVGW jNSMIB cZpRAh").addClass("ckUMfu");
					}
					// 선택된 버튼을 배열에 추가
					...
					for (var i = 0; i < selectedBtns.length; i++) {
						...
						selectedBtn.removeClass("ckUMfu jNSMIB cZpRAh").addClass("eWrVZP");
					}
				}
				);
			});
